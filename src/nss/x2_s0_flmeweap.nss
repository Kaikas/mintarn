...
void main()
{
   ...
   object oMyWeapon   =  IPGetTargetedOrEquippedMeleeWeapon();
    ...
    //filtering creature weapons
   int iCreatureWeapon = 0;
   if(GetBaseItemType(oMyWeapon) == BASE_ITEM_CBLUDGWEAPON ||
      GetBaseItemType(oMyWeapon) == BASE_ITEM_CPIERCWEAPON ||
      GetBaseItemType(oMyWeapon) == BASE_ITEM_CSLASHWEAPON ||
      GetBaseItemType(oMyWeapon) == BASE_ITEM_CSLSHPRCWEAP){
      iCreatureWeapon = 1;
   }

   if(GetIsObjectValid(oMyWeapon) && !iCreatureWeapon)
   {
