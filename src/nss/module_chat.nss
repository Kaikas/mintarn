...
void main() {
    ...
    if (sFirstChar == ":") {
        ...
        // Delete Characters
            ...
            } else if (sMessage == "/greet" || sMessage == "/winken" || sMessage == "/grüßen") {
           ...
           // Überleben
            ...
            // PvP
                ...
                SendMessageToPC(oPc, "Ihr hab PvP (Spieler gegen Spieler) aktiviert und k�nnt nun angegriffen werden!");
            // Masks
