...
void main() {
    ...
    if (GetScriptParam("belohnung") == "mittel") {
        ...
        SendMessageToPC(oPc, "Große Belohnung (" + IntToString(iGivenXP) + ") an " + GetName(oTarget) + " vergeben");
    ...
    if (GetScriptParam("belohnung") == "groß") {
        ...
        SendMessageToPC(oPc, "Außerordentliche Belohnung (" + IntToString(iGivenXP) + ") an " + GetName(oTarget) + " vergeben");
