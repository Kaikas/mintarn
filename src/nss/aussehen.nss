...
void settoken() {
    ...
    SetCustomToken(1028, "Hellt�rkis");
    SetCustomToken(1029, "Duneklt�rkis");
    SetCustomToken(1030, "Hellgr�n");
    SetCustomToken(1031, "Dunkelgr�n");
    ...
    SetCustomToken(1044, "Wei� (gl�nzend)");
    SetCustomToken(1045, "Schwarz (gl�nzend)");
    SetCustomToken(1046, "Blau (gl�nzend)");
    SetCustomToken(1047, "Aquamarin (gl�nzend)");
    SetCustomToken(1048, "T�rkis (gl�nzend)");
    SetCustomToken(1049, "Gr�n (gl�nzend)");
    SetCustomToken(1050, "Gelb (gl�nzend)");
    SetCustomToken(1051, "Orange (gl�nzend)");
    SetCustomToken(1052, "Rot (gl�nzend)");
    SetCustomToken(1053, "Rosa (gl�nzend)");
    SetCustomToken(1054, "Lila (gl�nzend)");
    SetCustomToken(1055, "Violett (gl�nzend)");
    ...
    SetCustomToken(1062, "Reines Wei�");
    ...
    SetCustomToken(1068, "Gr�n Metallic");
    SetCustomToken(1069, "Gr�n Metallic");
    ...
    SetCustomToken(1076, "T�rkis Metallic");
    SetCustomToken(1077, "T�rkis Metallic (gegraut)");
    ...
    SetCustomToken(1104, "Waldgr�n");
    SetCustomToken(1105, "Waldgr�n (hell)");
    SetCustomToken(1106, "Waldgr�n");
    SetCustomToken(1107, "Waldgr�n (dunkel)");
    ...
    SetCustomToken(1140, "Hellstes Mattt�rkis");
    SetCustomToken(1141, "Helles Mattt�rkis");
    SetCustomToken(1142, "Mattt�rkis");
    SetCustomToken(1143, "Dunkles Mattt�rkis");
    ...
    SetCustomToken(1152, "Hell-Saftgr�n");
    SetCustomToken(1153, "Saftgr�n");
...
void setmetaltoken() {
    SetCustomToken(1000, "Silber (sehr hell, gl�nzend)");
    SetCustomToken(1001, "Silber (hell, gl�nzend)");
    SetCustomToken(1002, "Obisdian (dunkel, gl�nzend)");
    SetCustomToken(1003, "Obsidian (sehr dunkel, gl�nzend)");
    ...
    SetCustomToken(1036, "Hellt�rkis");
    SetCustomToken(1037, "Dunkelt�rkis");
    SetCustomToken(1038, "Hellt�rkis (matt)");
    SetCustomToken(1039, "Dunkelt�rkis (matt)");
    SetCustomToken(1040, "Hellgr�n");
    SetCustomToken(1041, "Dunkelgr�n");
    SetCustomToken(1042, "Hellgr�n (matt)");
    SetCustomToken(1043, "Dunkelgr�n (matt)");
    ...
    SetCustomToken(1085, "Marshland Metallic");
    SetCustomToken(1086, "Marshland Metallic (gegraut)");
    SetCustomToken(1087, "Farngr�nes Metallic");
    SetCustomToken(1088, "Hellstes Rot Metallic");
    SetCustomToken(1089, "Hellrot Metallic");
    SetCustomToken(1090, "Rot Metallic");
    SetCustomToken(1091, "Dunkelrot Metallic");
    ...
    SetCustomToken(1139, "Dunkel-Mitternachtsblau");
    SetCustomToken(1140, "Hellstes Mattt�rkis");
    SetCustomToken(1141, "Helles Matt�rkis");
    SetCustomToken(1142, "Mattt�rkis");
    SetCustomToken(1143, "Dunkles Mattt�rkis");
    SetCustomToken(1144, "Hellstes Magenta");
    SetCustomToken(1145, "Hellmagenta");
